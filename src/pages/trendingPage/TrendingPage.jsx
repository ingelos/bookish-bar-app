                        ...
                        <div className='result-content-container'>
                            {books.map((book) => (
                                ...
                                <BookCard
                                    ...
                                    cover={book.cover_edition_key ? `https://covers.openlibrary.org/b/olid/${book.cover_edition_key}-M.jpg` : '' || book.cover_i ? `https://covers.openlibrary.org/b/id/${book.cover_i}-M.jpg` : ''}
